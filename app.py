...
st.markdown(
    ...
    /* Casillas de texto: fondo blanco y letra negra, aunque el resto
       de la app esté en modo oscuro */
    ...
    /* Menú desplegable del selectbox también legible (fondo blanco, texto negro) */
