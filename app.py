        ...
        try {{
          ...
          if (err.name !== "AbortError") {{
            if (err.name === "NotAllowedError") {{
              msg_{id_sufijo}.textContent = "Tu navegador/dispositivo ha bloqueado el envío directo de este archivo (algunos Android no permiten compartir ciertos tipos de archivo así, aunque sí fotos y PDF). Descárgalo con el botón de abajo y adjúntalo manualmente en WhatsApp.";
            }} else {{
