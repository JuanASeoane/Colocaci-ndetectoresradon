...
st.markdown(
    ...
    /* Casillas de texto y desplegables: SOLO el recuadro donde se
       escribe/selecciona queda en blanco con letra negra y un 25% más
       grande (1rem -> 1.25rem). La etiqueta de encima (el texto que
       describe el campo, con testid "stWidgetLabel") se excluye a
       propósito para que quede sobre el fondo gris de la ventana. */
    ...
    /* Menú desplegable del selectbox también legible y agrandado */
...
def pantalla_centro():
    ...
    with st.expander("Datos del centro", expanded=True):
        ...
        with c2:
            widget_imagen("Imagen exterior", ns_centro + "_img", key_prefix=ns_centro + "_imgw", con_boton_quitar=False)
