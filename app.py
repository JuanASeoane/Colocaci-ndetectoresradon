...
st.markdown(
    ...
    /* Casillas de texto y desplegables: fondo blanco, letra negra y
       un 50% más grandes (tamaño base 1rem -> 1.5rem), aunque el resto
       de la app esté en modo oscuro. Cubre tanto la casilla de "Nuevo
       centro" como el desplegable de centros/detectores. */
