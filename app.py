...
def pantalla_centro():
    ...
    if not detectores:
        ...
        if ya_generado:
            ...
            # 4) Seleccionar todas + checklist individual de fotos
            seleccionadas = []
