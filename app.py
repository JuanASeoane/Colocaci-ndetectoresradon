...
def generar_pdf(centro_id, output_path):
    try:
        ...
        for idx, d in enumerate(detectores, 1):
            ...
            filas_texto = [
                ["Codigo detector", codigo or "-", "Codigo espacio", codigo_sala or "-"],
                ["Planta", planta or "-", "Nivel", nivel or "-"],
                ["Sala", sala or "-", "Hora colocacion", hora_colocacion or "-"],
                ["Fecha colocacion", fecha_det or "-", "Fecha retirada", ""],
                ["Fecha optima retirada", fecha_retirada_optima_pdf or "-", "", ""],
