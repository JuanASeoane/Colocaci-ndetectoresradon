# -*- coding: utf-8 -*-
"""
APP DE RADON PARA STREAMLIT - CON SLIDERS Y PUNTO ROJO
=======================================================
"""
...
# ============================================================
# COMPONENTE DE PLANO CON SLIDERS Y PUNTO ROJO EN TIEMPO REAL
# ============================================================

def plano_con_sliders(plano_path, punto_x=-1, punto_y=-1, key="plano"):
    """
    Muestra un plano con sliders para seleccionar la ubicación.
    El punto rojo se actualiza en tiempo real al mover los sliders.
    """
    ...
    try:
        ...
        # Crear imagen con el punto rojo
        def dibujar_plano_con_punto(x, y):
            img_copy = img.copy()
        ...
        # Si los sliders cambiaron, actualizar
        if nuevo_x != punto_x or nuevo_y != punto_y:
...
# ============================================================
# PÁGINA DE DETECTOR CON PLANO Y SLIDERS
# ============================================================
...
def page_detector():
    ...
    # --- PLANO CON SLIDERS (fuera del form) ---
    ...
    if plano_actual and os.path.exists(plano_actual):
        nuevo_px, nuevo_py = plano_con_sliders(
            plano_actual, 
