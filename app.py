# -*- coding: utf-8 -*-
"""
APP DE RADON PARA STREAMLIT - VERSIÓN SIMPLE Y FUNCIONAL
=========================================================
"""
...
def init_session_state():
    ...
    # Variables para el plano - SIEMPRE inicializadas
...
# ============================================================
# PÁGINA DE DETECTOR - VERSIÓN SIMPLIFICADA CON SLIDERS SIEMPRE VISIBLES
# ============================================================
...
def page_detector():
    ...
    if plano_existe:
        ...
        if img_con_punto:
            st.image(img_con_punto, caption="📍 Plano con ubicación del detector", use_container_width=True)
        else:
    ...
    st.caption("Arrastra los sliders para mover el punto rojo en el plano")
